...
class PanSuperclass(object):
    ...
    def init_protein_clusters_functions(self):
        ...
        # available functions
        a_protein_cluster = list(self.protein_clusters_functions_dict.values())[0]
        self.protein_clusters_function_sources = list(list([v for v in list(a_protein_cluster.values()) if v][0].values())[0].keys())
